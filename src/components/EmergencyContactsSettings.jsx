...
const EmergencyContactsSettings = ({ onClose }) => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            {/* Notification */}
            {notification && (
                <div className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 ${notification.type === 'success' ? 'bg-emerald-950/90 border border-emerald-800/50' : 'bg-red-950/90 border border-red-800/50'
                    }`}>
