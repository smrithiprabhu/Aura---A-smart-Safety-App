                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className={`w-12 h-7 rounded-full transition-all relative ${
                          call.enabled ? 'bg-green-600' : 'bg-gray-700'
                        }`}
                      >
                        <div
                          className={`w-5 h-5 bg-white rounded-full transition-transform absolute top-1 ${
                            call.enabled ? 'translate-x-6' : 'translate-x-1'
                          }`}
                        ></div>
                      </button>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-14 h-8 rounded-full transition-all relative ${
                  gesturesEnabled ? 'bg-green-600' : 'bg-gray-700'
                }`}
              >
                <div
                  className={`w-6 h-6 bg-white rounded-full transition-transform absolute top-1 ${
                    gesturesEnabled ? 'translate-x-7' : 'translate-x-1'
                  }`}
                ></div>
              </button>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <span className={`text-xs px-2 py-1 rounded mt-2 inline-block ${
                    gesturesEnabled ? 'bg-green-600/20 text-green-400' : 'bg-gray-700 text-gray-500'
                  }`}>
